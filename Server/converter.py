...
# Enable CORS for all routes (you can modify origins as needed)
...
@app.route("/")
def home():
    return jsonify({"message": "Welcome to the PDF Play API!"}), 200
...
def merge_pdfs():
    ...
    try:
        ...
        return send_file(str(output_path), as_attachment=True, status=200)
